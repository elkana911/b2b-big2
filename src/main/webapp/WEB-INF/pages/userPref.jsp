...
<div class="col-sm-7">
	...
	<div class="well">
        ...
        <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
            ...
            <c:if test="${pageContext.request.remoteUser == user.username || pageContext.request.remoteUser == 'admin'}">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
                ...
                <appfuse:label styleClass="control-label" key="user.firstName"/><span class="required">&nbsp;*</span>
            ...
            <div class="col-sm-6 form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
                ...
                <appfuse:label styleClass="control-label" key="user.lastName"/><span class="required">&nbsp;*</span>
...
<!--               <button type="submit" class="btn btn-default" name="delete" onclick="bCancel=true;return confirmMessage(msgDelConfirm)"> -->
              <button class="btn btn-default" name="delete" id="submitDelete" onclick="bCancel=true;return false;">
