...
<script type="text/javascript">
	...
	$.getJSON("${pageContext.request.contextPath}/getQFormAdults")
		.done(function (data){
	    	dewasa = data;
	...
	$.getJSON("${pageContext.request.contextPath}/getQFormChildren")
		.done(function (data){
	    	anak = data;
			...
			$.contextMenu({
		        ...
		        items: loadQItems(anak)
		    });
		</c:forEach>	    	
	});

	if (${maBookingForm.searchForm.infants} > 0)
	$.getJSON("${pageContext.request.contextPath}/getQFormInfants")
		.done(function (data){
	    	bayi = data;
			...
			$.contextMenu({
		        ...
		        items: loadQItems(bayi)
		    });
		</c:forEach>
	});
	
	$.getJSON("${pageContext.request.contextPath}/getQFormContacts")
	.done(function (data){
    	ccust = data;
