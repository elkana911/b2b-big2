...
<div class="col-sm-7">
    ...
    <form:form commandName="agentBean" method="post" action="../agent/agentform" id="agentForm"
...
<!--               <button type="submit" class="btn btn-default" name="delete" onclick="bCancel=true;return confirmMessage(msgDelConfirm)"> -->
              <button class="btn btn-default" name="delete" onclick="bCancel=true;return false">
