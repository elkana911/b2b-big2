...
public class HandlerCancel extends SqivaAction implements ISqivaAction {
	private RequestCancel request;
	
	public HandlerCancel(ConfigUrl configUrl, RequestCancel request) {
	...
	public Object execute() throws Exception{
		...
		UriBuilder uri = buildPreUrl(Action.CANCEL_BOOK)
...
//		String data = "{ \"err_code\": \"001003\", \"err_msg\": \"Book Code UUU123 does not exist or already canceled\" }";
		...
		ResponseCancel resp = new ResponseCancel();
		...
		resp.setRefund_amount(rootNode.path("refund_amount").getIntValue());
