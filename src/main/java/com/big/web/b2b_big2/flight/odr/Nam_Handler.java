...
public class Nam_Handler extends BasicAirlineHandler implements IAirlineHandler {

	private static Nam_Handler self = null;

	public static Nam_Handler getInstance(ISetupDao setupDao){
		if (self == null)
			self = new Nam_Handler(setupDao);
		
		return self;
	}
	
	private Nam_Handler(ISetupDao setupDao) {
		super(Airline.NAM, setupDao);
	}
	...
	private int convertToInt(BigDecimal value){
		return Utils.convertToInt(value, Airline.NAM);
	}
