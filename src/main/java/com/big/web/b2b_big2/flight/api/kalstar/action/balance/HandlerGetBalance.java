...
public class HandlerGetBalance extends SqivaAction implements ISqivaAction {
	private RequestGetBalance request;
	
	public HandlerGetBalance(ConfigUrl configUrl, RequestGetBalance request) {
	...
	public Object execute() throws Exception{
		...
		UriBuilder uri = buildPreUrl(Action.GET_BALANCE)
...
//		{ "err_code": "0", "book_code": "9UX7JJ", "num_code": 1117017514978, "normal_sales": 1544000, "book_balance": 0, "book_ancillary_fee":[] }

		ResponseGetBalance resp = new ResponseGetBalance();
		...
		resp.setNum_code(rootNode.path("num_code").getIntValue());
