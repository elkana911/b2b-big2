...
@Controller
public class HotelRetrieveBookingController extends BaseFormController {
    ...
    * @return
    */
   @RequestMapping(value = "/hotel/b2b/retrievebooking", method = RequestMethod.GET)
...
//       }
       ...
       return new ModelAndView("/hotel/hotelRetrieveBooking").addObject("bookingcode", bookingCode);
   }
   
   @RequestMapping(value = "/hotel/b2b/retrievebooking*", method = RequestMethod.POST)
   public ModelAndView onSubmit(
           @RequestParam(value = "bookingcode", required = true) final String bookingCode,
...
/*
       ...
       if (user != null) {
		...
		if (bf == null){
			...
			return showForm(bookingCode, request);
		}
       return new ModelAndView("redirect:/hotel/b2b/booking/" + bf.getId());
 */
       return null;
