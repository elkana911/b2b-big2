...
public interface UserManager extends GenericManager<User, Long> {
     ...
     *
     * @deprecated
     * @see UserManager#removeUser(String)
     * @param user the user to remove
     */
    void removeUser(User user);

    /**
     * Removes a user from the database by their userId, beserta table2 terkair
     *
     ...
     */
    User updatePassword(String username, String currentPassword, String recoveryToken, String newPassword, String applicationUrl, boolean sendEmail) throws UserExistsException;
