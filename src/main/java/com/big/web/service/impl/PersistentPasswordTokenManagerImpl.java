...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.big.web.service.impl.PasswordTokenManager#generateRecoveryToken(com.big.web.model.User)
     */
    @Override
    ...
    /**
     * @see com.big.web.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.big.web.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.big.web.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
